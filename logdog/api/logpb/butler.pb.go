...
// 	protoc        v3.12.1
// source: github.com/tetrafolium/luci-go/logdog/api/logpb/butler.proto
...
var file_go_chromium_org_luci_logdog_api_logpb_butler_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_logdog_api_logpb_butler_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_logdog_api_logpb_butler_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_logdog_api_logpb_butler_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_logdog_api_logpb_butler_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
