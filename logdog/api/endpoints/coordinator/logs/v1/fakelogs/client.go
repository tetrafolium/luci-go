...
import (
	...
	logs_api "github.com/tetrafolium/luci-go/logdog/api/endpoints/coordinator/logs/v1"
	reg_api "github.com/tetrafolium/luci-go/logdog/api/endpoints/coordinator/registration/v1"
	services_api "github.com/tetrafolium/luci-go/logdog/api/endpoints/coordinator/services/v1"
	...
	reg_impl "github.com/tetrafolium/luci-go/logdog/appengine/coordinator/endpoints/registration"
	services_impl "github.com/tetrafolium/luci-go/logdog/appengine/coordinator/endpoints/services"
	logs_impl "github.com/tetrafolium/luci-go/logdog/appengine/coordinator/flex/logs"
	"github.com/tetrafolium/luci-go/logdog/client/butlerlib/streamproto"
	mem_storage "github.com/tetrafolium/luci-go/logdog/common/storage/memory"
