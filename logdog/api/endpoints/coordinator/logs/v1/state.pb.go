...
// 	protoc        v3.12.1
// source: github.com/tetrafolium/luci-go/logdog/api/endpoints/coordinator/logs/v1/state.proto
...
func (x *LogStreamState) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
var file_go_chromium_org_luci_logdog_api_endpoints_coordinator_logs_v1_state_proto_goTypes = []interface{}{
...
func file_go_chromium_org_luci_logdog_api_endpoints_coordinator_logs_v1_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_go_chromium_org_luci_logdog_api_endpoints_coordinator_logs_v1_state_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_go_chromium_org_luci_logdog_api_endpoints_coordinator_logs_v1_state_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LogStreamState_ArchiveInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
