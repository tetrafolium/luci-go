...
// 	protoc        v3.12.1
// source: github.com/tetrafolium/luci-go/cipd/client/cipd/internal/messages/messages.proto
...
func (x *InstanceCache) GetLastSynced() *timestamp.Timestamp {
	if x != nil {
		return x.LastSynced
	}
	return nil
...
func (x *InstanceCache_Entry) GetLastAccess() *timestamp.Timestamp {
	if x != nil {
		return x.LastAccess
	}
	return nil
