...
// 	protoc        v3.12.1
// source: github.com/tetrafolium/luci-go/appengine/mapper/messages.proto
...
type ShardInfo struct {
	...
	Created           *timestamp.Timestamp `protobuf:"bytes,4,opt,name=created,proto3" json:"created,omitempty"`                                               // when it was created
	Updated           *timestamp.Timestamp `protobuf:"bytes,5,opt,name=updated,proto3" json:"updated,omitempty"`                                               // when it was updated last time
	Eta               *timestamp.Timestamp `protobuf:"bytes,6,opt,name=eta,proto3" json:"eta,omitempty"`                                                       // when it finishes (if tracking progress)
...
func (x *ShardInfo) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *ShardInfo) GetUpdated() *timestamp.Timestamp {
	if x != nil {
		return x.Updated
	}
	return nil
...
func (x *ShardInfo) GetEta() *timestamp.Timestamp {
	if x != nil {
		return x.Eta
	}
	return nil
...
type JobInfo struct {
	...
	Created           *timestamp.Timestamp `protobuf:"bytes,3,opt,name=created,proto3" json:"created,omitempty"`                                               // when it was created
	Updated           *timestamp.Timestamp `protobuf:"bytes,4,opt,name=updated,proto3" json:"updated,omitempty"`                                               // when it was updated last time
	Eta               *timestamp.Timestamp `protobuf:"bytes,5,opt,name=eta,proto3" json:"eta,omitempty"`                                                       // when it finishes (if tracking progress)
...
func (x *JobInfo) GetCreated() *timestamp.Timestamp {
	if x != nil {
		return x.Created
	}
	return nil
...
func (x *JobInfo) GetUpdated() *timestamp.Timestamp {
	if x != nil {
		return x.Updated
	}
	return nil
...
func (x *JobInfo) GetEta() *timestamp.Timestamp {
	if x != nil {
		return x.Eta
	}
	return nil
