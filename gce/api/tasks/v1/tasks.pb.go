...
// source: github.com/tetrafolium/luci-go/gce/api/tasks/v1/tasks.proto
...
import (
	...
	v1 "github.com/tetrafolium/luci-go/gce/api/config/v1"
	math "math"
)
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/gce/api/tasks/v1/tasks.proto", fileDescriptor_f63d8744087b0bbc)
}
