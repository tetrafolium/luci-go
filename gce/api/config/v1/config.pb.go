...
// source: github.com/tetrafolium/luci-go/gce/api/config/v1/config.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/gce/api/config/v1/config.proto", fileDescriptor_56a5743e153a90ec)
}
