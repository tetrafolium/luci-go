...
// Package main is generated by github.com/tetrafolium/luci-go/tools/cmd/assets.
//
...
var files = map[string]string{
	...
	"swarming-start-bot.service.tmpl": string([]byte{35, 32,
		...
		61, 32, 123, 123, 46, 80, 121, 116, 104, 111, 110, 125, 125, 32,
		123, 123, 46, 66, 111, 116, 67, 111, 100, 101, 125, 125, 32, 115,
		116, 97, 114, 116, 95, 98, 111, 116, 10, 10, 91, 73, 110, 115,
		116, 97, 108, 108, 93, 10, 87, 97, 110, 116, 101, 100, 66, 121,
		61, 109, 117, 108, 116, 105, 45, 117, 115, 101, 114, 46, 116, 97,
		114, 103, 101, 116, 10}),
}
...
var fileSha256s = map[string][]byte{
	...
	"swarming-start-bot.conf.tmpl": {202, 12,
		...
		80, 147},
	"swarming-start-bot.service.tmpl": {105, 250,
		29, 75, 39, 210, 97, 40, 80, 164, 27, 221, 132, 159, 65, 104,
		191, 163, 217, 206, 109, 231, 143, 145, 44, 81, 228, 116, 37, 107,
		162, 20},
}
