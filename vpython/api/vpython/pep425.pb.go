...
// source: github.com/tetrafolium/luci-go/vpython/api/vpython/pep425.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/vpython/api/vpython/pep425.proto", fileDescriptor_06702d5b59b98781)
}
