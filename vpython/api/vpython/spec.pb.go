...
// source: github.com/tetrafolium/luci-go/vpython/api/vpython/spec.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/vpython/api/vpython/spec.proto", fileDescriptor_12b41745b49e8c72)
}
