...
// source: github.com/tetrafolium/luci-go/tools/cmd/bqschemaupdater/testdata/event.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/tools/cmd/bqschemaupdater/testdata/event.proto", fileDescriptor_aee82e0b1f3dea43)
}
