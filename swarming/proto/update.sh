...
sed -i 's#"swarming\.proto"#"github.com/tetrafolium/luci-go/swarming/proto/api/swarming.proto"#' api/*.proto
sed -i 's#"config\.proto"#"github.com/tetrafolium/luci-go/swarming/proto/config/config.proto"#' config/*.proto
sed -i 's#"realms\.proto"#"github.com/tetrafolium/luci-go/swarming/proto/config/realms.proto"#' config/*.proto
