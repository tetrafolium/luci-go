...
// source: github.com/tetrafolium/luci-go/grpc/prpc/talk/buildbot/proto/buildbot.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/grpc/prpc/talk/buildbot/proto/buildbot.proto", fileDescriptor_64b66e62512000da)
}
...
var _Buildbot_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/tetrafolium/luci-go/grpc/prpc/talk/buildbot/proto/buildbot.proto",
}
