...
// source: github.com/tetrafolium/luci-go/machine-db/api/crimson/v1/platforms.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/machine-db/api/crimson/v1/platforms.proto", fileDescriptor_764b10c00d1d2476)
}
