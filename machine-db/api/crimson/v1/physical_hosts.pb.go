...
// source: github.com/tetrafolium/luci-go/machine-db/api/crimson/v1/physical_hosts.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/machine-db/api/crimson/v1/physical_hosts.proto", fileDescriptor_fc4ca5e2610d2a30)
}
