...
// source: github.com/tetrafolium/luci-go/machine-db/api/common/v1/states.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/machine-db/api/common/v1/states.proto", fileDescriptor_f170d7ecb0c39b98)
}
