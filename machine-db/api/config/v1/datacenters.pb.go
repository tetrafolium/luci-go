...
// source: github.com/tetrafolium/luci-go/machine-db/api/config/v1/datacenters.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/machine-db/api/config/v1/datacenters.proto", fileDescriptor_ddd85d9fa4d73ee0)
}
