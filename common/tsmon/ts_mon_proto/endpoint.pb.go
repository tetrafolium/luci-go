...
// source: github.com/tetrafolium/luci-go/common/tsmon/ts_mon_proto/endpoint.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/common/tsmon/ts_mon_proto/endpoint.proto", fileDescriptor_933117f6dff2e889)
}
