...
// source: github.com/tetrafolium/luci-go/common/tsmon/ts_mon_proto/timestamp.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/common/tsmon/ts_mon_proto/timestamp.proto", fileDescriptor_7afd1967c97dbebc)
}
