...
// source: github.com/tetrafolium/luci-go/common/tsmon/ts_mon_proto/acquisition_task.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/common/tsmon/ts_mon_proto/acquisition_task.proto", fileDescriptor_c9556040af6e102a)
}
