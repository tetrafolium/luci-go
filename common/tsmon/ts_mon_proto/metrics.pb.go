...
// source: github.com/tetrafolium/luci-go/common/tsmon/ts_mon_proto/metrics.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/common/tsmon/ts_mon_proto/metrics.proto", fileDescriptor_5a1f5514585a4442)
}
