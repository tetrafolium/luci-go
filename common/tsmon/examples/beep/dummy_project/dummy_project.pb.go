...
// source: github.com/tetrafolium/luci-go/common/tsmon/examples/beep/dummy_project/dummy_project.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/common/tsmon/examples/beep/dummy_project/dummy_project.proto", fileDescriptor_1ee4a422b2719059)
}
