...
// source: github.com/tetrafolium/luci-go/common/proto/examples/examples.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/common/proto/examples/examples.proto", fileDescriptor_4ffcd71d7b665008)
}
