...
// source: github.com/tetrafolium/luci-go/common/bq/testdata/testmessage.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/common/bq/testdata/testmessage.proto", fileDescriptor_bc9d446aa0b4e493)
}
