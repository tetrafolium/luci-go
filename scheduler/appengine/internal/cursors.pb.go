...
// source: github.com/tetrafolium/luci-go/scheduler/appengine/internal/cursors.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/scheduler/appengine/internal/cursors.proto", fileDescriptor_dded6d90ada69499)
}
