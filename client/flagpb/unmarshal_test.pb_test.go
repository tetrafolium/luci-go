...
// source: github.com/tetrafolium/luci-go/client/flagpb/unmarshal_test.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/client/flagpb/unmarshal_test.proto", fileDescriptor_7e62106924695bf0)
}
