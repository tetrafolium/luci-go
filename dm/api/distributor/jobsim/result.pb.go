...
// source: github.com/tetrafolium/luci-go/dm/api/distributor/jobsim/result.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/dm/api/distributor/jobsim/result.proto", fileDescriptor_f53ecbabb0d591b3)
}
