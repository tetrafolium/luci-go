...
// source: github.com/tetrafolium/luci-go/dm/api/distributor/distributor.proto
...
import (
	...
	jobsim "github.com/tetrafolium/luci-go/dm/api/distributor/jobsim"
	v1 "github.com/tetrafolium/luci-go/dm/api/distributor/swarming/v1"
	math "math"
)
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/dm/api/distributor/distributor.proto", fileDescriptor_ae589283bac413cb)
}
