...
// source: github.com/tetrafolium/luci-go/dm/api/service/v1/finish_attempt.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/dm/api/service/v1/finish_attempt.proto", fileDescriptor_31dc2b787f3be2cf)
}
