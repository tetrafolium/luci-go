...
// source: github.com/tetrafolium/luci-go/dm/api/service/v1/graph_query.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/dm/api/service/v1/graph_query.proto", fileDescriptor_922ae0b01ed267cc)
}
