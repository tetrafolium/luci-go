...
// source: github.com/tetrafolium/luci-go/dm/api/template/template.proto
...
import (
	...
	v1 "github.com/tetrafolium/luci-go/dm/api/service/v1"
	math "math"
)
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/dm/api/template/template.proto", fileDescriptor_374a6f94bcadcedb)
}
