...
// source: github.com/tetrafolium/luci-go/server/auth/delegation/messages/delegation.proto
...
func init() {
	proto.RegisterFile("github.com/tetrafolium/luci-go/server/auth/delegation/messages/delegation.proto", fileDescriptor_67dd1eacea24f38c)
}
